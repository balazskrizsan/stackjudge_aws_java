...
public class RemoteFilesRecord extends TableRecordImpl<RemoteFilesRecord> implements Record5<UUID, String, String, String, String> {
    ...
    @Override
    public RemoteFilesRecord value1(UUID value) {
        setId(value);
        return this;
    }
    ...
    @Override
    public RemoteFilesRecord values(UUID value1, String value2, String value3, String value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RemoteFilesRecord(UUID id, String path, String filename, String s3ETag, String s3ContentMd5) {
        super(RemoteFiles.REMOTE_FILES);
